...
gmshcmd = "../../../gmsh/gmsh-4.7.1-Linux64/bin/gmsh"
...
dolfin.File(directory + "bivmesh.pvd") << fenics_mesh_ref;
dolfin.File(directory + "bivfacet.pvd") << fenics_facet_ref;
dolfin.File(directory + "bivedge.pvd") << fenics_edge_ref; 
...
ugrid = vtk_py.readXMLUGrid(directory + "bivmesh000000.vtu")
...
cmd = "cp " + directory + meshname +".hdf5" + " " + directory + meshname + "_refine.hdf5"
os.system(cmd)
