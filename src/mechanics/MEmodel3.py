...
class MEmodel(object):
    ...
    def Problem(self):
        ...
        def poro_Forms():
            # new parameters: T, p_a, p_v, bet_a, beta_v, permeability, ...
            ...
            F_1 = (1 / state_obj.dt.dt) * (p_me - p_me_n) * q_me * dx_me  + dot(permeability * grad(uflforms.poro_pressure()), grad(q_me)) * dx_me
            F_2 = self.LVCavitypres * inner(v_me, N_me) * ds_me(LVendoid) + inner(grad(v_me), uflforms.poro_PK_1()) * dx_me
