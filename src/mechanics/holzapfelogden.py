                ...
                if float(a) > dolfin.DOLFIN_EPS:
                    if float(b) > dolfin.DOLFIN_EPS:
                        return (
                            a
                            / (2.0 * b)
                            * (dolfin.exp(b * self.subplus(self.I4s() - 1) ** 2) - 1.0)
                        )
                    else:
                ...
                if float(a) > dolfin.DOLFIN_EPS:
                    if float(b) > dolfin.DOLFIN_EPS:
                        return (
                            a
                            / (2.0 * b)
                            * (dolfin.exp(b * self.subplus(self.I4f() - 1) ** 2) - 1.0)
                        )
                    else:
                ...
                if float(a) > dolfin.DOLFIN_EPS:
                    if float(b) > dolfin.DOLFIN_EPS:
                        W4s = (
                            a
                            / (2.0 * b)
                            * (dolfin.exp(b * self.subplus(I4s - 1) ** 2) - 1.0)
                        )
                    else:
                ...
                if float(a) > dolfin.DOLFIN_EPS:
                    if float(b) > dolfin.DOLFIN_EPS:
                        W4f = (
                            a
                            / (2.0 * b)
                            * (dolfin.exp(b * self.subplus(I4f - 1) ** 2) - 1.0)
                        )
                    else:
