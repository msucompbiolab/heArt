...
for ux in ux_array:
    ...
    (
        ...
        activematparams,
        passivematparams,
    ) = run_isometric(IODet=IODetails, SimDet=SimDetails)
    active_load_analytical = [
        TV_analytical(lbda, t_a, activematparams) * lbda for t_a in tpt_array
    ]
